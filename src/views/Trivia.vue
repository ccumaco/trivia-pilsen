...
export default {
  ...
  methods:{
    ...
    async startTrivia() {
      ...
      axios({
        method: "post",
        url: "https://test-pilsendelsur.pantheonsite.io/ab/trivia/start?_format=json",
        data: info,
        headers: {
    ...
    nextQuestion() {
      ...
      axios({
        method: "post",
        url: "https://test-pilsendelsur.pantheonsite.io/ab/trivia/q/next?_format=json",
        data: inf2,
        headers: {
          "Content-Type": "application/json",
          "Access-Control-Allow-Origin": "*"
    ...
    AskQuestion() {
      ...
      axios({
        method: "post",
        url: "https://test-pilsendelsur.pantheonsite.io/ab/trivia/q/answer?_format=json",
        data: inf3,
        headers: {
          "Content-Type": "application/json",
          "Access-Control-Allow-Origin": "*"
