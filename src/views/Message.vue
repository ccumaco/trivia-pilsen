    ...
    .cc-message__grid
      ...
      .cc-message__content
        ...
        p.cc-message__txt(v-if="!isChecked") 
          ...
          //- br
          //- br
          vue-recaptcha(v-if="!isChecked" sitekey="6LeSGvoaAAAAAISLJWHBRU1OaqvKxDv251Mbl5z3", loadRecaptchaScript=true @verify="onCaptchaVerified" @expired="onCaptchaExpired") 
          //- (v-if="isChecked")
