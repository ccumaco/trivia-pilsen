...
export default {
  ...
  methods: {
    ...
    triviaResults() {
      ...
      axios({
        method: "post",
        url: "https://test-pilsendelsur.pantheonsite.io/ab/trivia/time?_format=json",
        data: info,
        headers: {
    ...
    checkTrivia(){
      ...
      axios({
        method: "post",
        url: "https://test-pilsendelsur.pantheonsite.io/ab/challenge/checkrobot?_format=json",
        data: info,
        headers: { "Content-Type": "application/json" }
      })
      .then((response) => {
    ...
    generarPersonalRanking() {
      ...
      axios({
        method: "post",
        url: "https://test-pilsendelsur.pantheonsite.io/ab/trivia/ranking/customer?_format=json",
        data: info,
        headers: {
          "Content-Type": "application/json"
        }
